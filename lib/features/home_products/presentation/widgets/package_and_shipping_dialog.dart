...
class PackagingShippingDialog extends StatefulWidget {
  const PackagingShippingDialog({super.key, required this.sneaker});

  final SneakerVO sneaker;

  @override
  State<PackagingShippingDialog> createState() =>
      _PackagingShippingDialogState();
}

class _PackagingShippingDialogState extends State<PackagingShippingDialog> {
